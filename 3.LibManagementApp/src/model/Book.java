...
public class Book extends DataAccessHelper {
    ...
    private ArrayList<CopyOfBook> listCopyOfBook;
    private ArrayList<Author> listAuthor;
    
    private final String GET_LIST_IDAUTHOR = "SELECT * FROM quan_ly_thu_vien.chitiettacgia where maSach=?";
    private final String ADD_BOOK = "INSERT INTO quan_ly_thu_vien.sach VALUES (?,?,?,?,?)";
    private final String ADD_DETAIL_AUTHOR = "INSERT INTO quan_ly_thu_vien.chitiettacgia VALUES (?,?)";
    private final String SEARCH_BOOK = "select * from sach where tenSach like ?";
    
    public Book() {}

    public Book(String idBook, String titleBook, String nameAuthor, String theLoai, ArrayList<CopyOfBook> listCopyOfBook, Publisher publisher) {
        this.idBook = idBook;
        this.titleBook = titleBook;
        this.nameAuthor = nameAuthor;
        this.theLoai = theLoai;
        this.listCopyOfBook = listCopyOfBook;
    ...
    public void setIsbn(String theLoai) {
        this.theLoai = theLoai;
    }

    public ArrayList<CopyOfBook> getListCopyOfBook() {
        return listCopyOfBook;
    }

    public void setListCopyOfBook(ArrayList<CopyOfBook> listCopyOfBook) {
        this.listCopyOfBook = listCopyOfBook;
    }
    ...
    public Book getBookByIdBook(String idBook) throws ClassNotFoundException, SQLException {
        Book book = new Book();
        connectDatabase();
        PreparedStatement st = conn.prepareStatement("SELECT * FROM quan_ly_thu_vien.sach where maSach = ?");
        st.setString(1, idBook);
        ResultSet rs = st.executeQuery();
        while (rs.next()) {
            ...
            book = new Book(idBook, titleBook, nameAuthor, theLoai, listBanSao, publisher);
        }
        closeDatabase();
        return book;
    }
    ...
    public ArrayList<Book> getBookByInfo(String info) throws ClassNotFoundException, SQLException {
        ...
        connectDatabase();
        Book book;
        String sqlCommand = "SELECT sach.maSach,tenSach,tenNhaPhatHanh,tenTacGia,sach.theLoai,nhaphathanh.maNhaPhatHanh FROM sach, tacgia,nhaphathanh,chitiettacgia where sach.maSach like '%" + info + "%' \n"
                ...
                + "union\n"
                + "(SELECT sach.maSach,tenSach,tenNhaPhatHanh,tenTacGia,sach.theLoai,nhaphathanh.maNhaPhatHanh  FROM sach, tacgia,nhaphathanh,chitiettacgia where sach.tenSach like '%" + info + "%' \n"
                + "and sach.maSach = chitiettacgia.maSach and chitiettacgia.maTacGia =tacgia.maTacGia\n"
                + "and sach.maNhaPhatHanh = nhaphathanh.maNhaPhatHanh group by sach.maSach\n"
                + ")\n"
                + "union\n"
                + "(SELECT sach.maSach,tenSach,tenNhaPhatHanh,tenTacGia,sach.theLoai,nhaphathanh.maNhaPhatHanh  FROM sach, tacgia,nhaphathanh,chitiettacgia where nhaphathanh.tenNhaPhatHanh like '%" + info + "%' \n"
                + "and sach.maSach = chitiettacgia.maSach and chitiettacgia.maTacGia =tacgia.maTacGia\n"
                + "and sach.maNhaPhatHanh = nhaphathanh.maNhaPhatHanh group by sach.maSach\n"
                + ")\n"
                + "union\n"
                + "(SELECT sach.maSach,tenSach,tenNhaPhatHanh,tenTacGia,sach.theLoai,nhaphathanh.maNhaPhatHanh  FROM sach, tacgia,nhaphathanh,chitiettacgia where tacgia.tenTacGia like '%" + info + "%' \n"
                + "and sach.maSach = chitiettacgia.maSach and chitiettacgia.maTacGia =tacgia.maTacGia\n"
                + "and sach.maNhaPhatHanh = nhaphathanh.maNhaPhatHanh group by sach.maSach\n"
                + ")";
        ...
        while (rs.next()) {
            ...
            String nameAuthor = getNameAuthorByIdBook(idBook);
            ArrayList<CopyOfBook> listBanSao = new CopyOfBook().getListCopyOfBookByIdBook(idBook);
            book = new Book(idBook, titleBook, nameAuthor, theLoai, listBanSao, namePublisher);
            books.add(book);
        }
        return books;
    }
    ...
    public Object[] searchAuthor(String maSach) throws SQLException, ClassNotFoundException {
        ...
        ResultSet rs = null;
        PreparedStatement preparedStatement;
        String sql = "select sach.maSach,sach.tenSach,nhaphathanh.tenNhaPhatHanh,tacgia.tenTacGia,sach.theLoai from  sach,tacgia,nhaphathanh,chitiettacgia \n"
