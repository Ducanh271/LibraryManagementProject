...
public class Publisher extends DataAccessHelper{
    ...
    private final String GET_LIST_PUBLISHER = "SELECT * FROM quan_ly_thu_vien.nhaphathanh";
    private final String GET_MAX_ID = "SELECT MAX(maNhaPhatHanh) FROM quan_ly_thu_vien.nhaphathanh";
    private final String ADD_PUBLISHER = "INSERT INTO quan_ly_thu_vien.nhaphathanh";
    ...
    public Publisher getPublisherByIdPublisher(int idPublisher) throws SQLException, ClassNotFoundException {
        ...
        connectDatabase();
        PreparedStatement st = conn.prepareStatement("SELECT * FROM quan_ly_thu_vien.nhaphathanh where maNhaPhatHanh =?");
